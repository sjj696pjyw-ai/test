          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-gray-900 dark:text-white">
                Анализируйте цены
                <span className="text-primary-600 dark:text-primary-300"> конкурентов</span> без
                лишней работы
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
              PriceMonitor закрывает полный цикл — от поиска конкурентов до отчёта с ценовыми
              различиями
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="group card hover:shadow-lg hover:border-primary-200 dark:hover:border-primary-800 transition-all duration-300"
              >
                <div
            ...
            {[
              ...
              <div key={i} className="relative">
                ...
                <div className="text-center">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${item.color} shadow-lg flex items-center justify-center text-white font-bold text-lg`}
                  >
                    {item.step}
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
      ...
      {!user && (
        <section className="relative overflow-hidden py-24 bg-gradient-to-br from-primary-500 to-primary-700 dark:from-primary-600 dark:via-primary-700 dark:to-primary-800 text-white">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Готовы попробовать?</h2>
